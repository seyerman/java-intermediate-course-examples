...
public class ClockGUI {
    ...
    public void updateClock(double angleHour, double angleMinute) {
    	lineHourHand.getTransforms().add(new Rotate(angleHour,lineHourHand.getEndX(),lineHourHand.getEndY()));
    	lineMinuteHand.getTransforms().add(new Rotate(angleMinute,lineMinuteHand.getEndX(),lineMinuteHand.getEndY()));    	
    }
}
